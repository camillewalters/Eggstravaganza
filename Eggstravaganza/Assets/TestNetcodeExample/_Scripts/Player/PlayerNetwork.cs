...
public class PlayerNetwork : NetworkBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            transform.position = Vector3.SmoothDamp(transform.position, m_NetState.Value.Position, ref m_Velocity, m_InterpolationTime);
            transform.rotation = Quaternion.Euler(
                0f,
                Mathf.SmoothDampAngle(transform.rotation.eulerAngles.y, m_NetState.Value.Rotation.y, ref m_RotationVelocity, m_InterpolationTime),
                0f);
        }
    }
}
